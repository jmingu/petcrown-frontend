            ...
            <div className="prose prose-sm max-w-none space-y-8">
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  PetCrown은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
                </p>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  PetCrown은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  PetCrown은 원칙적으로 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
                </p>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  PetCrown은 현재 개인정보 처리 업무를 외부 업체에 위탁하지 않습니다. 향후 위탁이 필요한 경우, 사전에 위탁 업체명, 위탁 업무 내용 등을 공개하고 동의를 받겠습니다.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mt-3">
                  권리 행사는 개인정보보호법 시행규칙 별지 제8호 서식에 따라 작성 후 서면, 전자우편 등을 통하여 하실 수 있으며, PetCrown은 이에 대해 지체없이 조치하겠습니다.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  PetCrown은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
                </p>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  PetCrown은 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  PetCrown은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
                </p>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  이 개인정보 처리방침은 2025년 12월 1일부터 적용됩니다. 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.
                </p>
              </section>

              {/* 공고일자 */}
              <div className="text-sm text-gray-500 border-t pt-4">
                <div>공고일자: 2025년 12월 1일</div>
                <div>시행일자: 2025년 12월 1일</div>
              </div>
            </div>
          </CuteCard>
        </motion.div>
