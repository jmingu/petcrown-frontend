...
import { Trophy, ArrowLeft, Gamepad2, Crown, Medal, Timer, X } from 'lucide-react';
...
import { getWeeklyRankings, getLastWeeklyRankings } from '@/libs/api/game/gameApi';
                  ...
                  <CuteCard className="text-center relative overflow-hidden">
                    ...
                    <div className="pt-4 pb-3 px-2">
                      ...
                      <div
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          if (topThree[1].imageUrl) {
                            setExpandedImage(topThree[1].imageUrl);
                          }
                        }}
                      >
                        {topThree[1].imageUrl ? (
                  ...
                  <CuteCard className="text-center relative overflow-visible">
                    ...
                    <div className="pt-6 pb-4 px-2">
                      ...
                      <div
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          if (topThree[0].imageUrl) {
                            setExpandedImage(topThree[0].imageUrl);
                          }
                        }}
                      >
                        {topThree[0].imageUrl ? (
                      ...
                      <div className="flex items-center justify-center space-x-2 mb-3">
                        <Timer className="w-4 h-4 md:w-5 md:h-5 text-purple-500" />
                        <span className="font-bold text-lg md:text-xl text-purple-600">
                          {topThree[0].score.toFixed(1)}초
                        </span>
                      </div>
                  ...
                  <CuteCard className="text-center relative overflow-hidden">
                    ...
                    <div className="pt-4 pb-3 px-2">
                      ...
                      <div
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          if (topThree[2].imageUrl) {
                            setExpandedImage(topThree[2].imageUrl);
                          }
                        }}
                      >
                        {topThree[2].imageUrl ? (
